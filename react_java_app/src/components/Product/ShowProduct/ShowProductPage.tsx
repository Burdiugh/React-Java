          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full object-cover object-center rounded">
              <div className="relative">
                <div className="relative h-96 w-full overflow-hidden rounded-lg bg-white group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 h-64 lg:aspect-w-1 lg:aspect-h-1">
                  <div className="picture-main">
                    {/* <img
                      alt="ecommerce"
                      className="picture-container"
                      src={`http://localhost:8082/api/home/files/600_${model.files[0]}`}
                    /> */}
                      ...
                      >
                        <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                          ...
                          >
                            <img
                              src={
                                "http://localhost:8082/api/home/files/1200_" +
                                model?.files[currentImageIndex]
                              }
                              className="absolute block w-full h-96 -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                              alt=""
                            />
                          </div>
                          {/* ))} */}
